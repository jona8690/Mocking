...
namespace Mocking
{
    ...
    public class MockTests
    {
        ...
        public void CanCalulateAverageWeeklySaleryPerEmployee()
        {
            ...
            double weeklyAverageSalary = 0.0d;

            List<Employee> employees = mock.Object.FindAllEmployees();
            foreach (var e in employees)
            {
                weeklyAverageSalary += e.CalculateWeeklySalary(hours, e.Wage);
            }

            weeklyAverageSalary = weeklyAverageSalary / employees.Count;

            Assert.AreEqual(expectedResult, weeklyAverageSalary);
        ...
        public void ChangeType()
        {
            ...
            //Act
            mockLogin.Object.Login(admin);
            admin.EditEmployeeType(e, "Teacher");

            //Assert
            Assert.AreEqual("Teacher", e.Type);
        }
